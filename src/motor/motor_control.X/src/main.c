...
void main(void) {
    ...
    TRISA = 0xFF;	// set RA3-RA0 to intputs
...
#else
    OpenTimer1(TIMER_INT_ON & T1_PS_1_8 & T1_16BIT_RW & T1_SOURCE_INT & T1_OSC1EN_OFF);
    WriteTimer1(65390);
#endif
...
#else
    // If I want to test the temprature sensor from the ARM, I just make
